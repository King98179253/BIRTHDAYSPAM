...
async def DEADLYSPAM():
    ...
    if STRING:
        ...
        try:
            ...
            await SAM(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING2:
        ...
        try:
            ...
            await SAM2.start()
            await SAM2(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM2(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM2(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING3:
        ...
        try:
            ...
            await  SAM3.start()
            await SAM3(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM3(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM3(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING4:
        ...
        try:
            ...
            await SAM4.start()
            await SAM4(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM4(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM4(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING5:
        ...
        try:
            ...
            await SAM5.start()
            await SAM5(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM5(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM5(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING6:
        ...
        try:
            ...
            await SAM6.start()
            await SAM6(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM6(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM6(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING7:
        ...
        try:
            ...
            await SAM7.start()
            await SAM7(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM7(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM7(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING8:
        ...
        try:
            ...
            await SAM8.start()
            await SAM8(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM8(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM8(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING9:
        ...
        try:
            ...
            await SAM9.start()
            await SAM9(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM9(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM9(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING10:
        ...
        try:
            ...
            await SAM10.start()
            await SAM10(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM10(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM10(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING11:
        ...
        try:
            ...
            await SAM11.start()
            await SAM11(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM11(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM11(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING12:
        ...
        try:
            ...
            await SAM12.start()
            await SAM12(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM12(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM12(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING13:
        ...
        try:
            ...
            await SAM13.start()
            await SAM13(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM13(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM13(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING14:
        ...
        try:
            ...
            await SAM14.start()
            await SAM14(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM14(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM14(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING15:
        ...
        try:
            ...
            await SAM15.start()
            await SAM15(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM15(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM15(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING16:
        ...
        try:
            ...
            await SAM16(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM16(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM16(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING17:
        ...
        try:
            ...
            await SAM17(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM17(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM17(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING18:
        ...
        try:
            ...
            await SAM18(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM18(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM18(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING19:
        ...
        try:
            ...
            await SAM19(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM19(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM19(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING20:
        ...
        try:
            ...
            await SAM20(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM20(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM20(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING21:
        ...
        try:
            ...
            await SAM21(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM21(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM21(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING22:
        ...
        try:
            ...
            await SAM22.start()
            await SAM22(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM22(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM22(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING23:
        ...
        try:
            ...
            await  SAM23.start()
            await SAM23(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM23(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM23(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING24:
        ...
        try:
            ...
            await SAM24.start()
            await SAM24(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM24(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM24(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING25:
        ...
        try:
            ...
            await SAM25.start()
            await SAM25(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM25(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM25(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING26:
        ...
        try:
            ...
            await SAM26.start()
            await SAM26(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM26(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM26(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING27:
        ...
        try:
            ...
            await SAM27.start()
            await SAM27(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM27(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM27(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING28:
        ...
        try:
            print("Booting Up The Client 18")
            await SAM28.start()
            await SAM28(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM28(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM28(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING29:
        ...
        try:
            ...
            await SAM29.start()
            await SAM29(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM29(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM29(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING30:
        ...
        try:
            ...
            await SAM30.start()
            await SAM30(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM30(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM30(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING31:
        ...
        try:
            ...
            await SAM31.start()
            await SAM31(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM31(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM31(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING32:
        ...
        try:
            print("Booting Up The Client 32")
            await SAM32.start()
            await SAM32(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM32(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM32(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING33:
        ...
        try:
            ...
            await SAM33.start()
            await SAM33(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM33(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM33(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING34:
        ...
        try:
            ...
            await SAM34.start()
            await SAM34(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM34(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM34(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING35:
        ...
        try:
            print("Booting Up The Client 35")
            await SAM35.start()
            await SAM35(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM35(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM35(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
    ...
    if STRING36:
        ...
        try:
            ...
            await SAM36(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM36(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM36(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING37:
        ...
        try:
            ...
            await SAM37(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM37(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM37(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING38:
        ...
        try:
            ...
            await SAM38(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM38(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM38(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING39:
        ...
        try:
            ...
            await SAM39(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM39(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM39(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING40:
        ...
        try:
            ...
            await SAM40(functions.channels.JoinChannelRequest(channel="@DRAGONZ_SUPPORT"))
            await SAM40(functions.channels.JoinChannelRequest(channel="@A_BUT"))
            await SAM40(functions.channels.JoinChannelRequest(channel="@subhi_gifs"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
...
loop.run_until_complete(BHATAKTISPAM())
